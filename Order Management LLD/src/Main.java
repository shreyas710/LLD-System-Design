...
import Product.WarehouseSelectionStrategy.NearestWarehouseSelectionStrategy;
import User.User;
import Order.Order;
...
public class Main {
    ...
    private Warehouse addWarehouseAndItsInventory(){
        ...
        inventory.addProductInventory(0001, "Peppsii Large Cold Drink" , 100);
        inventory.addProductInventory(0004, "Doovee small Soap" , 50);
    ...
    private void runDeliveryFlow(ProductDeliverySystem productDeliverySystem, int userId){
        ...
        ProductInventory productCategoryIWantToOrder = null;
        for(ProductInventory productCategory : inventory.productInventoryList){

            if(productCategory.productInventoryName.equals("Peppsii Large Cold Drink")){
